...
public class FileUtil {
    ...
    public static final String PIC3_PATH = FileUtil.IMG_PATH + "Picture2.png";
    public static final String PIC4_PATH = FileUtil.IMG_PATH + "Picture4.png";
    public static final String PIC5_PATH = FileUtil.IMG_PATH + "Picture5.png";
    public static final String PIC6_PATH = FileUtil.IMG_PATH + "Picture6.png";
}
